...
app.get('/api/me', (request, response) => {
	response.send('{"name": "Bryan Gullan", "location": "Earth"}');
	logger.info('Responded to GET request on /api/me')
});

app.get('/api/work', (request, response) => {
	response.send('[{"yearFrom": "2014", "yearTo": "2019", "place": "Makkaru", "comment": "Still doing stuff"}, {"yearFrom": "2011", "yearTo": "2014", "place": "HH", "comment": "Making coffee"}]');
